...
export type AttackId = 'jab' | 'cross' | 'uppercut' | 'dash' | 'air' | 'slide';
...
export const ATTACKS: Record<Role, Record<AttackId, AttackDefinition>> = {
  chen: { jab: ground('punch', .05, .045, .175, 35), cross: ground('punch', .06, .05, .16, 45), uppercut: ground('uppercut', .075, .065, .20, 55, true), dash, air, slide },
  tuo: { jab: ground('punch', .06, .06, .22, 25), cross: ground('punch', .075, .065, .20, 35), uppercut: ground('uppercut', .09, .08, .23, 45, true), dash, air, slide },
  man: { jab: ground('punch', .04, .04, .14, 45), cross: ground('punch', .045, .045, .13, 55), uppercut: ground('uppercut', .06, .06, .16, 65, true), dash, air, slide },
};

...
import { HEROES, StreetGame, type Action, type Role } from '../../game/street/simulation';
import './street.css';
...
export default function StreetPage() {
  ...
  const [role, setRole] = useState<Role>('chen'); const [muted, setMuted] = useState(false); const muteRef = useRef(false);
